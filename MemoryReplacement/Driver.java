...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("BEST FIT FRAGMENT COUNT => "+worstFitMemoryController.fragmentCount());
        ...
        System.out.println("\n\nBEST FIT FAILS COUNT=> "+fails);
        System.out.println("BEST FIT FRAGMENT COUNT => "+firstFitMemoryController.fragmentCount());
        System.out.println("BEST FIT NUMBER OF HOPS => "+numberOfHops);
        //--------------------------------------------------------------------------------------------------------------------------------------
